...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__48101 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__48102 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__48102,x_SINGLEQUOTE__48101,this$){
return (function (p1__48100_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__48100_SHARP_,id_SINGLEQUOTE__48102),id,x_SINGLEQUOTE__48101);
});})(id_SINGLEQUOTE__48102,x_SINGLEQUOTE__48101,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__48101);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__46081__auto__,writer__46082__auto__,opt__46083__auto__){
return cljs.core._write.call(null,writer__46082__auto__,"om.next.cache/Cache");
});
...
//# sourceMappingURL=cache.js.map?rel=1498049871245