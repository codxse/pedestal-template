...
om.transit.TempIdHandler.cljs$lang$ctorPrWriter = (function (this__46081__auto__,writer__46082__auto__,opt__46083__auto__){
return cljs.core._write.call(null,writer__46082__auto__,"om.transit/TempIdHandler");
});
...
var args61663 = [];
var len__46645__auto___61666 = arguments.length;
var i__46646__auto___61667 = (0);
while(true){
if((i__46646__auto___61667 < len__46645__auto___61666)){
args61663.push((arguments[i__46646__auto___61667]));

var G__61668 = (i__46646__auto___61667 + (1));
i__46646__auto___61667 = G__61668;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args61663.length)].join('')));
...
var args61670 = [];
var len__46645__auto___61673 = arguments.length;
var i__46646__auto___61674 = (0);
while(true){
if((i__46646__auto___61674 < len__46645__auto___61673)){
args61670.push((arguments[i__46646__auto___61674]));

var G__61675 = (i__46646__auto___61674 + (1));
i__46646__auto___61674 = G__61675;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args61670.length)].join('')));
...
//# sourceMappingURL=transit.js.map?rel=1498049885384